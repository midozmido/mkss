...
(function () {
  ...
  var T = {
    name: 1.35,        /* دخول الاسم */
    tag: 1.10,         /* السطر تحت اللوجو */
    creep: 3.20,       /* زحف الشريط نحو ٠٫٩ */
    floor: 2100,       /* أقل مدة عرض — يمنع الوميض حين تكون الأصول في الكاش */
    cap: 3000,         /* السقف الأقصى للانتظار */
    hold: 0.38,        /* سكون بعد اكتمال الشريط */
    open: 1.95         /* توسّع الفتحة */
  };
